...
function fillTable() {
  ...
  for (var r = 1; r < 19; r++){
    ...
    var text0 = document.createTextNode(values[r]);
    var text1 = document.createTextNode(numValues[r]);
    var text2 = document.createTextNode(stringValues[r]);
    var text3 = document.createTextNode(booleanValues[r]);
